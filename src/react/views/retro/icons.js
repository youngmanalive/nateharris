...
const Icon = ({ size, viewBox = '0 0 16 16', children }) => (
  <svg viewBox={viewBox} className="retro-icon" style={{ width: size + 'px' }}>
    {children}
  </svg>
);
...
export const Cone = ({ size = 28 }) => (
  <Icon size={size}>
    <polygon points="8,1 12,14 4,14" fill="#ff6600" stroke="#cc4400" strokeWidth="0.3" />
    <rect x="5" y="4" width="6" height="2" fill="#ffcc00" />
    <rect x="4.5" y="8" width="7" height="2" fill="#ffcc00" />
    <rect x="3" y="14" width="10" height="1.5" fill="#333" />
    <rect x="7.2" y="1" width="1.6" height="1.5" fill="#ff6600" rx="0.8" />
  </Icon>
);
